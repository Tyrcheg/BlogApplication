...
namespace BlogApp.BLL.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        readonly IUserRepository _userRepository = new UserRepository(AppContext.Create());
        ...
        [HttpPost]
        [Route("Register")]
        public async Task<IHttpActionResult> Register(UserVM userModel)
        {
        ...
        #region AspNetIdentity autogenerated code
